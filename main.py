...
import sys 
import os
sys.path.append(os.path.abspath("./3. Notebook to script/1- regression"))
sys.path.append(os.path.abspath("./3. Notebook to script/2- classification"))
...
#################################
#### classification
path = "./4. Test Data/Classification/winequality-red.csv"
